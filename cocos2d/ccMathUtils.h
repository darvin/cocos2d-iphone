...
extern "C" {
    ...
    static __inline__ float CCMathDegreesToRadians(float degrees) { return degrees * (M_PI / 180); };
    static __inline__ float CCMathRadiansToDegrees(float radians) { return radians * (180 / M_PI); };
