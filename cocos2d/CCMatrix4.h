...
#pragma mark -
     ...
     */
    static __inline__ CCMatrix4 CCMatrix4Make(float m00, float m01, float m02, float m03,
     ...
     */
    static __inline__ CCMatrix4 CCMatrix4MakeAndTranspose(float m00, float m01, float m02, float m03,
                                                            float m10, float m11, float m12, float m13,
                                                            float m20, float m21, float m22, float m23,
                                                            float m30, float m31, float m32, float m33);
     ...
     */
    static __inline__ CCMatrix4 CCMatrix4MakeWithArray(float values[16]);
    
    /*
     m[3], m[7], and m[11] correspond to the translation values tx, ty, and tz, respectively.
     */
    static __inline__ CCMatrix4 CCMatrix4MakeWithArrayAndTranspose(float values[16]);
    
    /*
     row0, row1, and row2's last component should correspond to the translation values tx, ty, and tz, respectively.
     */
    static __inline__ CCMatrix4 CCMatrix4MakeWithRows(CCVector4 row0,
                                                        CCVector4 row1,
                                                        CCVector4 row2,
                                                        CCVector4 row3);
     ...
     */
    static __inline__ CCMatrix4 CCMatrix4MakeWithColumns(CCVector4 column0,
                                                           CCVector4 column1,
                                                           CCVector4 column2,
                                                           CCVector4 column3);
     ...
     */
    static __inline__ CCMatrix4 CCMatrix4MakeWithQuaternion(CCQuaternion quaternion);
	
    static __inline__ CCMatrix4 CCMatrix4MakeTranslation(float tx, float ty, float tz);
    static __inline__ CCMatrix4 CCMatrix4MakeScale(float sx, float sy, float sz);
    static __inline__ CCMatrix4 CCMatrix4MakeRotation(float radians, float x, float y, float z);
    
    static __inline__ CCMatrix4 CCMatrix4MakeXRotation(float radians);
    static __inline__ CCMatrix4 CCMatrix4MakeYRotation(float radians);
    static __inline__ CCMatrix4 CCMatrix4MakeZRotation(float radians);
    
    /*
     Equivalent to gluPerspective.
     */
    static __inline__ CCMatrix4 CCMatrix4MakePerspective(float fovyRadians, float aspect, float nearZ, float farZ);
    
    /*
     Equivalent to glFrustum.
     */
    static __inline__ CCMatrix4 CCMatrix4MakeFrustum(float left, float right,
     ...
     */
    static __inline__ CCMatrix4 CCMatrix4MakeOrtho(float left, float right,
                                                     float bottom, float top,
                                                     float nearZ, float farZ);
     ...
     */
    static __inline__ CCMatrix4 CCMatrix4MakeLookAt(float eyeX, float eyeY, float eyeZ,
     ...
     */
    static __inline__ CCMatrix3 CCMatrix4GetMatrix3(CCMatrix4 matrix);
    /*
     Returns the upper left 2x2 portion of the 4x4 matrix.
     */
    static __inline__ CCMatrix2 CCMatrix4GetMatrix2(CCMatrix4 matrix);
     ...
     */
    static __inline__ CCVector4 CCMatrix4GetRow(CCMatrix4 matrix, int row);
    /*
     ...
     */
    static __inline__ CCVector4 CCMatrix4GetColumn(CCMatrix4 matrix, int column);
    
    /*
     CCMatrix4SetRow expects that the vector for row 0, 1, and 2 will have a translation value as its last component.
     Valid row values range from 0 to 3, inclusive.
     */
    static __inline__ CCMatrix4 CCMatrix4SetRow(CCMatrix4 matrix, int row, CCVector4 vector);
    /*
     ...
     Valid column values range from 0 to 3, inclusive.
     */
    static __inline__ CCMatrix4 CCMatrix4SetColumn(CCMatrix4 matrix, int column, CCVector4 vector);
    
    static __inline__ CCMatrix4 CCMatrix4Transpose(CCMatrix4 matrix);
    
    extern __inline__ CCMatrix4 CCMatrix4Invert(CCMatrix4 matrix, bool *isInvertible);
    
    CCMatrix4 CCMatrix4InvertAndTranspose(CCMatrix4 matrix, bool *isInvertible);
    
    static __inline__ CCMatrix4 CCMatrix4Multiply(CCMatrix4 matrixLeft, CCMatrix4 matrixRight);
    
    static __inline__ CCMatrix4 CCMatrix4Add(CCMatrix4 matrixLeft, CCMatrix4 matrixRight);
    static __inline__ CCMatrix4 CCMatrix4Subtract(CCMatrix4 matrixLeft, CCMatrix4 matrixRight);
    
    static __inline__ CCMatrix4 CCMatrix4Translate(CCMatrix4 matrix, float tx, float ty, float tz);
    static __inline__ CCMatrix4 CCMatrix4TranslateWithVector3(CCMatrix4 matrix, CCVector3 translationVector);
    /*
     The last component of the CCVector4, translationVector, is ignored.
     */
    static __inline__ CCMatrix4 CCMatrix4TranslateWithVector4(CCMatrix4 matrix, CCVector4 translationVector);
    
    static __inline__ CCMatrix4 CCMatrix4Scale(CCMatrix4 matrix, float sx, float sy, float sz);
    static __inline__ CCMatrix4 CCMatrix4ScaleWithVector3(CCMatrix4 matrix, CCVector3 scaleVector);
    /*
     The last component of the CCVector4, scaleVector, is ignored.
     */
    static __inline__ CCMatrix4 CCMatrix4ScaleWithVector4(CCMatrix4 matrix, CCVector4 scaleVector);
    
    static __inline__ CCMatrix4 CCMatrix4Rotate(CCMatrix4 matrix, float radians, float x, float y, float z);
    static __inline__ CCMatrix4 CCMatrix4RotateWithVector3(CCMatrix4 matrix, float radians, CCVector3 axisVector);
    /*
     The last component of the CCVector4, axisVector, is ignored.
     */
    static __inline__ CCMatrix4 CCMatrix4RotateWithVector4(CCMatrix4 matrix, float radians, CCVector4 axisVector);
    
    static __inline__ CCMatrix4 CCMatrix4RotateX(CCMatrix4 matrix, float radians);
    static __inline__ CCMatrix4 CCMatrix4RotateY(CCMatrix4 matrix, float radians);
    static __inline__ CCMatrix4 CCMatrix4RotateZ(CCMatrix4 matrix, float radians);
    
    /*
     Assumes 0 in the w component.
     */
    static __inline__ CCVector3 CCMatrix4MultiplyVector3(CCMatrix4 matrixLeft, CCVector3 vectorRight);
    /*
     Assumes 1 in the w component.
     */
    static __inline__ CCVector3 CCMatrix4MultiplyVector3WithTranslation(CCMatrix4 matrixLeft, CCVector3 vectorRight);
    /*
     Assumes 1 in the w component and divides the resulting vector by w before returning.
     */
    static __inline__ CCVector3 CCMatrix4MultiplyAndProjectVector3(CCMatrix4 matrixLeft, CCVector3 vectorRight);
    
    /*
     Assumes 0 in the w component.
     */
    static __inline__ void CCMatrix4MultiplyVector3Array(CCMatrix4 matrix, CCVector3 *vectors, size_t vectorCount);
    /*
     Assumes 1 in the w component.
     */
    static __inline__ void CCMatrix4MultiplyVector3ArrayWithTranslation(CCMatrix4 matrix, CCVector3 *vectors, size_t vectorCount);
    /*
     Assumes 1 in the w component and divides the resulting vector by w before returning.
     */
    static __inline__ void CCMatrix4MultiplyAndProjectVector3Array(CCMatrix4 matrix, CCVector3 *vectors, size_t vectorCount);
    
    static __inline__ CCVector4 CCMatrix4MultiplyVector4(CCMatrix4 matrixLeft, CCVector4 vectorRight);
    
    static __inline__ void CCMatrix4MultiplyVector4Array(CCMatrix4 matrix, CCVector4 *vectors, size_t vectorCount);
