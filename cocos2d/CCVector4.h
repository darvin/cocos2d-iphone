...
#pragma mark -
    ...
    static __inline__ CCVector4 CCVector4Make(float x, float y, float z, float w);
    static __inline__ CCVector4 CCVector4MakeWithArray(float values[4]);
    static __inline__ CCVector4 CCVector4MakeWithVector3(CCVector3 vector, float w);
    
    static __inline__ CCVector4 CCVector4Negate(CCVector4 vector);
    
    static __inline__ CCVector4 CCVector4Add(CCVector4 vectorLeft, CCVector4 vectorRight);
    static __inline__ CCVector4 CCVector4Subtract(CCVector4 vectorLeft, CCVector4 vectorRight);
    static __inline__ CCVector4 CCVector4Multiply(CCVector4 vectorLeft, CCVector4 vectorRight);
    static __inline__ CCVector4 CCVector4Divide(CCVector4 vectorLeft, CCVector4 vectorRight);
    
    static __inline__ CCVector4 CCVector4AddScalar(CCVector4 vector, float value);
    static __inline__ CCVector4 CCVector4SubtractScalar(CCVector4 vector, float value);
    static __inline__ CCVector4 CCVector4MultiplyScalar(CCVector4 vector, float value);
    static __inline__ CCVector4 CCVector4DivideScalar(CCVector4 vector, float value);
	
    /*
     Returns a vector whose elements are the larger of the corresponding elements of the vector arguments.
     */
    static __inline__ CCVector4 CCVector4Maximum(CCVector4 vectorLeft, CCVector4 vectorRight);
    /*
     Returns a vector whose elements are the smaller of the corresponding elements of the vector arguments.
     */
    static __inline__ CCVector4 CCVector4Minimum(CCVector4 vectorLeft, CCVector4 vectorRight);
    
    /*
     Returns true if all of the first vector's elements are equal to all of the second vector's arguments.
     */
    static __inline__ bool CCVector4AllEqualToVector4(CCVector4 vectorLeft, CCVector4 vectorRight);
    /*
     Returns true if all of the vector's elements are equal to the provided value.
     */
    static __inline__ bool CCVector4AllEqualToScalar(CCVector4 vector, float value);
    /*
     Returns true if all of the first vector's elements are greater than all of the second vector's arguments.
     */
    static __inline__ bool CCVector4AllGreaterThanVector4(CCVector4 vectorLeft, CCVector4 vectorRight);
    /*
     Returns true if all of the vector's elements are greater than the provided value.
     */
    static __inline__ bool CCVector4AllGreaterThanScalar(CCVector4 vector, float value);
    /*
     Returns true if all of the first vector's elements are greater than or equal to all of the second vector's arguments.
     */
    static __inline__ bool CCVector4AllGreaterThanOrEqualToVector4(CCVector4 vectorLeft, CCVector4 vectorRight);
    /*
     Returns true if all of the vector's elements are greater than or equal to the provided value.
     */
    static __inline__ bool CCVector4AllGreaterThanOrEqualToScalar(CCVector4 vector, float value);
    
    static __inline__ CCVector4 CCVector4Normalize(CCVector4 vector);
    
    static __inline__ float CCVector4DotProduct(CCVector4 vectorLeft, CCVector4 vectorRight);
    static __inline__ float CCVector4Length(CCVector4 vector);
    static __inline__ float CCVector4Distance(CCVector4 vectorStart, CCVector4 vectorEnd);
    
    static __inline__ CCVector4 CCVector4Lerp(CCVector4 vectorStart, CCVector4 vectorEnd, float t);
    
    /*
     Performs a 3D cross product. The last component of the resulting cross product will be zeroed out.
     */
    static __inline__ CCVector4 CCVector4CrossProduct(CCVector4 vectorLeft, CCVector4 vectorRight);
	
    /*
     Project the vector, vectorToProject, onto the vector, projectionVector.
     */
    static __inline__ CCVector4 CCVector4Project(CCVector4 vectorToProject, CCVector4 projectionVector);
