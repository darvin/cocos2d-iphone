...
#pragma mark -
    ...
    static __inline__ CCVector2 CCVector2Make(float x, float y);
    static __inline__ CCVector2 CCVector2MakeWithArray(float values[2]);
    
    static __inline__ CCVector2 CCVector2Negate(CCVector2 vector);
    
    static __inline__ CCVector2 CCVector2Add(CCVector2 vectorLeft, CCVector2 vectorRight);
    static __inline__ CCVector2 CCVector2Subtract(CCVector2 vectorLeft, CCVector2 vectorRight);
    static __inline__ CCVector2 CCVector2Multiply(CCVector2 vectorLeft, CCVector2 vectorRight);
    static __inline__ CCVector2 CCVector2Divide(CCVector2 vectorLeft, CCVector2 vectorRight);
    
    static __inline__ CCVector2 CCVector2AddScalar(CCVector2 vector, float value);
    static __inline__ CCVector2 CCVector2SubtractScalar(CCVector2 vector, float value);
    static __inline__ CCVector2 CCVector2MultiplyScalar(CCVector2 vector, float value);
    static __inline__ CCVector2 CCVector2DivideScalar(CCVector2 vector, float value);
    
    /*
     Returns a vector whose elements are the larger of the corresponding elements of the vector arguments.
     */
    static __inline__ CCVector2 CCVector2Maximum(CCVector2 vectorLeft, CCVector2 vectorRight);
    /*
     Returns a vector whose elements are the smaller of the corresponding elements of the vector arguments.
     */
    static __inline__ CCVector2 CCVector2Minimum(CCVector2 vectorLeft, CCVector2 vectorRight);
    
    /*
     Returns true if all of the first vector's elements are equal to all of the second vector's arguments.
     */
    static __inline__ bool CCVector2AllEqualToVector2(CCVector2 vectorLeft, CCVector2 vectorRight);
    /*
     Returns true if all of the vector's elements are equal to the provided value.
     */
    static __inline__ bool CCVector2AllEqualToScalar(CCVector2 vector, float value);
    /*
     Returns true if all of the first vector's elements are greater than all of the second vector's arguments.
     */
    static __inline__ bool CCVector2AllGreaterThanVector2(CCVector2 vectorLeft, CCVector2 vectorRight);
    /*
     Returns true if all of the vector's elements are greater than the provided value.
     */
    static __inline__ bool CCVector2AllGreaterThanScalar(CCVector2 vector, float value);
    /*
     Returns true if all of the first vector's elements are greater than or equal to all of the second vector's arguments.
     */
    static __inline__ bool CCVector2AllGreaterThanOrEqualToVector2(CCVector2 vectorLeft, CCVector2 vectorRight);
    /*
     Returns true if all of the vector's elements are greater than or equal to the provided value.
     */
    static __inline__ bool CCVector2AllGreaterThanOrEqualToScalar(CCVector2 vector, float value);
    
    static __inline__ CCVector2 CCVector2Normalize(CCVector2 vector);
    
    static __inline__ float CCVector2DotProduct(CCVector2 vectorLeft, CCVector2 vectorRight);
    static __inline__ float CCVector2Length(CCVector2 vector);
    static __inline__ float CCVector2Distance(CCVector2 vectorStart, CCVector2 vectorEnd);
    
    static __inline__ CCVector2 CCVector2Lerp(CCVector2 vectorStart, CCVector2 vectorEnd, float t);
    
    /*
     Project the vector, vectorToProject, onto the vector, projectionVector.
     */
    static __inline__ CCVector2 CCVector2Project(CCVector2 vectorToProject, CCVector2 projectionVector);
