...
#pragma mark -
    ...
    static __inline__ CCVector3 CCVector3Make(float x, float y, float z);
    static __inline__ CCVector3 CCVector3MakeWithArray(float values[3]);
    
    static __inline__ CCVector3 CCVector3Negate(CCVector3 vector);
    
    static __inline__ CCVector3 CCVector3Add(CCVector3 vectorLeft, CCVector3 vectorRight);
    static __inline__ CCVector3 CCVector3Subtract(CCVector3 vectorLeft, CCVector3 vectorRight);
    static __inline__ CCVector3 CCVector3Multiply(CCVector3 vectorLeft, CCVector3 vectorRight);
    static __inline__ CCVector3 CCVector3Divide(CCVector3 vectorLeft, CCVector3 vectorRight);
    
    static __inline__ CCVector3 CCVector3AddScalar(CCVector3 vector, float value);
    static __inline__ CCVector3 CCVector3SubtractScalar(CCVector3 vector, float value);
    static __inline__ CCVector3 CCVector3MultiplyScalar(CCVector3 vector, float value);
    static __inline__ CCVector3 CCVector3DivideScalar(CCVector3 vector, float value);
	
    /*
     Returns a vector whose elements are the larger of the corresponding elements of the vector arguments.
     */
    static __inline__ CCVector3 CCVector3Maximum(CCVector3 vectorLeft, CCVector3 vectorRight);
    /*
     Returns a vector whose elements are the smaller of the corresponding elements of the vector arguments.
     */
    static __inline__ CCVector3 CCVector3Minimum(CCVector3 vectorLeft, CCVector3 vectorRight);
    
    /*
     Returns true if all of the first vector's elements are equal to all of the second vector's arguments.
     */
    static __inline__ bool CCVector3AllEqualToVector3(CCVector3 vectorLeft, CCVector3 vectorRight);
    /*
     Returns true if all of the vector's elements are equal to the provided value.
     */
    static __inline__ bool CCVector3AllEqualToScalar(CCVector3 vector, float value);
    /*
     Returns true if all of the first vector's elements are greater than all of the second vector's arguments.
     */
    static __inline__ bool CCVector3AllGreaterThanVector3(CCVector3 vectorLeft, CCVector3 vectorRight);
    /*
     Returns true if all of the vector's elements are greater than the provided value.
     */
    static __inline__ bool CCVector3AllGreaterThanScalar(CCVector3 vector, float value);
    /*
     Returns true if all of the first vector's elements are greater than or equal to all of the second vector's arguments.
     */
    static __inline__ bool CCVector3AllGreaterThanOrEqualToVector3(CCVector3 vectorLeft, CCVector3 vectorRight);
    /*
     Returns true if all of the vector's elements are greater than or equal to the provided value.
     */
    static __inline__ bool CCVector3AllGreaterThanOrEqualToScalar(CCVector3 vector, float value);
    
    static __inline__ CCVector3 CCVector3Normalize(CCVector3 vector);
    
    static __inline__ float CCVector3DotProduct(CCVector3 vectorLeft, CCVector3 vectorRight);
    static __inline__ float CCVector3Length(CCVector3 vector);
    static __inline__ float CCVector3Distance(CCVector3 vectorStart, CCVector3 vectorEnd);
    
    static __inline__ CCVector3 CCVector3Lerp(CCVector3 vectorStart, CCVector3 vectorEnd, float t);
    
    static __inline__ CCVector3 CCVector3CrossProduct(CCVector3 vectorLeft, CCVector3 vectorRight);
    
    /*
     Project the vector, vectorToProject, onto the vector, projectionVector.
     */
    static __inline__ CCVector3 CCVector3Project(CCVector3 vectorToProject, CCVector3 projectionVector);
