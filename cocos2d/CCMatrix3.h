...
#pragma mark -
    ...
    extern const CCMatrix3 CCMatrix3Identity;
    
    static __inline__ CCMatrix3 CCMatrix3Make(float m00, float m01, float m02,
                                                float m10, float m11, float m12,
                                                float m20, float m21, float m22);
    
    static __inline__ CCMatrix3 CCMatrix3MakeAndTranspose(float m00, float m01, float m02,
                                                            float m10, float m11, float m12,
                                                            float m20, float m21, float m22);
    
    static __inline__ CCMatrix3 CCMatrix3MakeWithArray(float values[9]);
    
    static __inline__ CCMatrix3 CCMatrix3MakeWithArrayAndTranspose(float values[9]);
    
    static __inline__ CCMatrix3 CCMatrix3MakeWithRows(CCVector3 row0,
                                                        CCVector3 row1,
                                                        CCVector3 row2);
    
    static __inline__ CCMatrix3 CCMatrix3MakeWithColumns(CCVector3 column0,
                                                           CCVector3 column1,
                                                           CCVector3 column2);
     ...
     */
    static __inline__ CCMatrix3 CCMatrix3MakeWithQuaternion(CCQuaternion quaternion);
    
    static __inline__ CCMatrix3 CCMatrix3MakeScale(float sx, float sy, float sz);
    static __inline__ CCMatrix3 CCMatrix3MakeRotation(float radians, float x, float y, float z);
    
    static __inline__ CCMatrix3 CCMatrix3MakeXRotation(float radians);
    static __inline__ CCMatrix3 CCMatrix3MakeYRotation(float radians);
    static __inline__ CCMatrix3 CCMatrix3MakeZRotation(float radians);
    
    /*
     Returns the upper left 2x2 portion of the 3x3 matrix.
     */
    static __inline__ CCMatrix2 CCMatrix3GetMatrix2(CCMatrix3 matrix);
    
    static __inline__ CCVector3 CCMatrix3GetRow(CCMatrix3 matrix, int row);
    static __inline__ CCVector3 CCMatrix3GetColumn(CCMatrix3 matrix, int column);
    
    static __inline__ CCMatrix3 CCMatrix3SetRow(CCMatrix3 matrix, int row, CCVector3 vector);
    static __inline__ CCMatrix3 CCMatrix3SetColumn(CCMatrix3 matrix, int column, CCVector3 vector);
    
    static __inline__ CCMatrix3 CCMatrix3Transpose(CCMatrix3 matrix);
    ...
    static __inline__ CCMatrix3 CCMatrix3Multiply(CCMatrix3 matrixLeft, CCMatrix3 matrixRight);
    
    static __inline__ CCMatrix3 CCMatrix3Add(CCMatrix3 matrixLeft, CCMatrix3 matrixRight);
    static __inline__ CCMatrix3 CCMatrix3Subtract(CCMatrix3 matrixLeft, CCMatrix3 matrixRight);
    
    static __inline__ CCMatrix3 CCMatrix3Scale(CCMatrix3 matrix, float sx, float sy, float sz);
    static __inline__ CCMatrix3 CCMatrix3ScaleWithVector3(CCMatrix3 matrix, CCVector3 scaleVector);
    /*
     The last component of the CCVector4, scaleVector, is ignored.
     */
    static __inline__ CCMatrix3 CCMatrix3ScaleWithVector4(CCMatrix3 matrix, CCVector4 scaleVector);
    
    static __inline__ CCMatrix3 CCMatrix3Rotate(CCMatrix3 matrix, float radians, float x, float y, float z);
    static __inline__ CCMatrix3 CCMatrix3RotateWithVector3(CCMatrix3 matrix, float radians, CCVector3 axisVector);
    /*
     The last component of the CCVector4, axisVector, is ignored.
     */
    static __inline__ CCMatrix3 CCMatrix3RotateWithVector4(CCMatrix3 matrix, float radians, CCVector4 axisVector);
    
    static __inline__ CCMatrix3 CCMatrix3RotateX(CCMatrix3 matrix, float radians);
    static __inline__ CCMatrix3 CCMatrix3RotateY(CCMatrix3 matrix, float radians);
    static __inline__ CCMatrix3 CCMatrix3RotateZ(CCMatrix3 matrix, float radians);
    
    static __inline__ CCVector3 CCMatrix3MultiplyVector3(CCMatrix3 matrixLeft, CCVector3 vectorRight);
    
    static __inline__ void CCMatrix3MultiplyVector3Array(CCMatrix3 matrix, CCVector3 *vectors, size_t vectorCount);
